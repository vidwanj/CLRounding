...
<%@ Register TagPrefix="WebPartPages" Namespace="Microsoft.SharePoint.WebPartPages"
    Assembly="Microsoft.SharePoint, Version=14.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Admin_DeptsRoomsUserControl.ascx.cs"
    Inherits="CLRSurvey.Admin_DeptsRooms.Admin_DeptsRoomsUserControl" %>
                ...
                <tbody class="spacing">
                    ...
                    <tr>
                        <td align="center" class="text-field-bg">
                            <asp:DropDownList ID="ddlDept" runat="server" Width="207px" OnSelectedIndexChanged="ddlDeptSelectedChange"
                                AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                        ...
                        <td align="center" class="text-field-bg">
                            <asp:DropDownList ID="ddlRoom" runat="server" Width="207px" OnSelectedIndexChanged="ddlRoomSelectedChange"
                                AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" align="center" style="height:10px" class="text-field-bg">
                            <asp:Label ID="lblDeptRoomMsg" runat="server" Text=" " ForeColor="#33CC33" Style="font-weight: 700"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center" class="text-field-bg">
                            <asp:ListBox ID="lstAvailable" runat="server" Width="207px" Height="173px" SelectionMode="Multiple">
                            </asp:ListBox>
                        </td>
                        ...
                        <td align="center" class="text-field-bg">
                            <asp:ListBox ID="lstMapped" runat="server" Width="207px" Height="173px" SelectionMode="Multiple">
                            </asp:ListBox>
                        </td>
                    </tr>
                    <tr>
